...
class Welcome extends React.Component {
    ...
    render() {
        ...
        <div className="welcome">
            <p className="welcome-p">Welcome! Buzz Kill is an application for tracking the blood alcohol content of bar patrons. Simply create a record for each of your customers and 
