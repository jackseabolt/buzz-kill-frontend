...
class Welcome extends React.Component {
    ...
    render() {
        ...
        <div className="welcome">
            <p className="welcome-p">Welcome! Buzz Kill is application for tracking the blood alcohol content of bar patrons. Simply create a record for your patron and 
